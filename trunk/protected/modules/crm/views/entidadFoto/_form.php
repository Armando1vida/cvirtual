...
<div class="widget blue">
    <div class="widget-title">
        <h4><i class="icon-plus"></i><?php echo Yii::t('AweCrud.app',$model->isNewRecord ? 'Create' : 'Update') . ' ' . EntidadFoto::label(1); ?></h4>
        <span class="tools">
    ...
    <div class="widget-body">
                                        ...
                                        <?php echo $form->textFieldRow($model, 'ruta', array('maxlength' => 512)) ?>
