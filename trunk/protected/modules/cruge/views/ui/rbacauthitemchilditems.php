<?php 
	...
	// titulos
        echo "<div class='well blue'>";
        echo "<div class='well-header'>";
        echo "<h5><i class='icon-key'> ".ucfirst($model->name)." (".
		CrugeTranslator::t($rbac->getAuthItemTypeName($model->type)).")</i></h5>";
  
        echo "</div>";
        echo "<div class='well-content'>";
