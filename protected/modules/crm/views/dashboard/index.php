        ...
        <div class="widget-body">
            <div class="tabbable portlet-tabs">
                <ul class="nav nav-tabs pull-left">
                    <li class=""><a href="#portlet_tab4" data-toggle="tab">Product Search</a></li>
                    <li class=""><a href="#portlet_tab3" data-toggle="tab">Company Search</a></li>
                    <li class=""><a href="#portlet_tab2" data-toggle="tab">File Search</a></li>
