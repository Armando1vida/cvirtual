...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . ProductoSubcategoria::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo ProductoSubcategoria::label(2) ?>    </legend>
