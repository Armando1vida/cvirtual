...
<div class="widget blue">
    <div class="widget-title">
        <h4><i class="icon-user"></i> <?php ?>Administración de  Usuarios</h4>
        <span class="tools">
...
$cols[] = array(
    ...
    'buttons' => array(
        'update' => array(
            ...
            'url' => 'array("usermanagementupdateroles","id"=>$data->getPrimaryKey())',
            'imageUrl' => false,
        ),
    ),
);
...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'dataProvider' => $model->searchCuentasAssign($owner_id),
    'filter' => $model,
    'columns' => $cols
));
?>
