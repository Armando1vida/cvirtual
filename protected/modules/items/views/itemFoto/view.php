...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . ItemFoto::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes' => array(
             ...
             array(
			'name' => 'item_id',
			'value'=>($model->item !== null) ? CHtml::link($model->item, array('/item/view', 'id' => $model->item->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
